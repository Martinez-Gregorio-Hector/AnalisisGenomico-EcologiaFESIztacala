...
Puedes configurar tus propias variables directamente desde la shell bash. Esta sección te muestra cómo crear tus propias variables y referenciarlas desde una shell interactiva o un script de shell.
