...
Cuando un programa se ejecuta en el sistema, se denomina proceso. Para examinar estos procesos, es necesario familiarizarse con el comando _*ps*_,sin embargo, el comando ps básico realmente no proporciona mucha información.

```
ps 

##    PID TTY          TIME CMD
## 449648 pts/2    00:00:00 bash
## 449704 pts/2    00:00:00 ps
```
