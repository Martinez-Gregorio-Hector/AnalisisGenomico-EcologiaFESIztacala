...
Antes de continuar con nuestra clase vamos a ver unos datos esciales con _*|*_, _*wc*_, _*>*_

```
# wc sirve para contar líneas tiene nuestro archivo, ejecutar el siguiente comando y decir cuantas líneas el archivp
wc -l flights.csv
# En el comando anterior con sort ordenaste solo la primera línea, que comando usaría para ordenar la columna 10 (dest)
