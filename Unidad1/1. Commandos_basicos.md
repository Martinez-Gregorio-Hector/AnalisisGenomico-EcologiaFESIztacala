...
Cuando se tiene una gran cantidad de datos, gestionar la información y hacerla útil puede ser difícil. Como se vio con el comando du en la sección anterior, es fácil sobrecargarse de datos al trabajar con comandos del sistema.

Linux ofrece varias herramientas de línea de comandos para facilitar la gestión de grandes cantidades de datos. Esta sección abarca los comandos básicos que todo administrador de sistemas, así como cualquier usuario habitual de Linux, debería saber usar para simplificar su trabajo.
