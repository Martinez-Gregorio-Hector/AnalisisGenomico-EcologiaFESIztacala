...
# Ordenar datos
El comando sort es una función popular que resulta útil al trabajar con grandes cantidades de datos. Su función es ordenar los datos.
De forma predeterminada, el comando sort ordena las líneas de datos de un archivo de texto utilizando las reglas de ordenación estándar del idioma que especifique como predeterminado para la sesión.
