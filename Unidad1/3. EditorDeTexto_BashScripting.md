...
Ejemplo de alineamiento generación de alineamiento múltiple con el alineador [muscle](https://github.com/rcedgar/muscle) y [Guía de Usuario](http://drive5.com/muscle/downloads3/muscle3.pdf)

Descargar la secuencia que vamos a usar

```
https://raw.githubusercontent.com/vinuesa/intro2linux/refs/heads/master/data/recA_Bradyrhizobium_vinuesa.fna
```
