...
Revisa este [manual de fastp](https://github.com/OpenGene/fastp) y establezca el ejercicio de [fastp](https://sxh1136.quarto.pub/amrflows-metagenomic-data-analysis-course/9.%20For-loops.html).

* Haz una carpeta con el nombre de practica2

* Realiza dentro de ella un bash scripting

* La dirección de los archivos fastq están en esta dirección: **/home/lab13/Documents/MAGH/Cahuantzi_Preneoplasias/PruebaEcologia**

* Genera un bucle for para procesar los archivos

* Guarde los archivos en una carpeta que se llame fastp_resultados
